...
*/
            ...
            */
            ...
            function ImportGKDLink() {
                var foretext = document.getElementById('pasteimage').value;
                if (foretext.substring(0, 6) == "gkd://" && foretext.substring(foretext.length - 1) == "/") {
                    var a = getSource(foretext)[0];
                    document.getElementById('tulip').src = a;
                    document.getElementById('source').src = a;
