/** 
 * This script is from https://www.jb51.net/article/140418.htm.
 * 
 * DES 加密算法 
 * 
...
function des (key, message, encrypt, mode, iv, padding) {
  ...
  var DES3 = {
    ...
    encrypt:function(key,input){
      ...
      return BASE64.encoder(des(genKey.key, input, 1, 1, des3iv, 1));
    },
    ////3DES解密，CBC/PKCS5Padding
    decrypt:function(key,input){
      var genKey = genkey(key, 0, 24); 
      return des(genKey.key, BASE64.decoder(input), 0, 1, des3iv, 1); 
    }
  };
